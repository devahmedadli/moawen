...
class StoreClientRequest extends BaseFormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'specialization_id.string'   => 'التخصص يجب أن يكون نصاً',
            'specialization_id.max'      => 'التخصص يجب ألا يتجاوز 255 حرفاً',
            'specialization_id.exists'   => 'يرجى التأكد من صحة التخصص',
